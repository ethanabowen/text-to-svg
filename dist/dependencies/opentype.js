...
(function (global, factory) {
    ...
    subtableMakers[4] = function makeLookup4(subtable) {
        ...
        return new table.Table('substitutionTable', [
            ...
            return new table.Table('ligatureSetTable', table.tableList('ligature', ligatureSet, function (ligature) {
                return new table.Table('ligatureTable', [{ name: 'ligGlyph', type: 'USHORT', value: ligature.ligGlyph }]
    ...
    */
    UnitVector.prototype.distance = function (p1, p2, o1, o2) {
        return (this.x * xUnitVector.distance(p1, p2, o1, o2) +
    ...
    */
    exec = function (state) {
        ...
        for (state.ip = 0; state.ip < pLen; state.ip++) {
            ...
            if (!ins) {
                throw new Error('unknown instruction: 0x' +
    ...
    *----------------------------------------------------------*/
    ...
    function SHP(a, state) {
        ...
        while (loop--) {
            ...
            fv.touch(p);
            if (exports.DEBUG) {
                console.log(state.step, (state.loop > 1 ?
    ...
    function SHPIX(state) {
        ...
        while (loop--) {
            ...
            var p = z2[pi];
            if (exports.DEBUG) {
                console.log(state.step, (state.loop > 1 ? 'loop ' + (state.loop - loop) + ': ' : '') +
                    'SHPIX[]', pi, d);
            }
    ...
    function MDRP_MIRP(indirect, setRp0, keepD, ro, dt, state) {
        ...
        fv.touch(p);
        if (exports.DEBUG) {
            console.log(state.step, (indirect ? 'MIRP[' : 'MDRP[') +
                (setRp0 ? 'M' : 'm') +
                (keepD ? '>' : '_') +
                (ro ? 'R' : '_') +
    ...
    *****/
    ...
    Tokenizer.prototype.insertToken = function (tokens, index, silent) {
        var tokenType = tokens.every(function (token) { return token instanceof Token; });
        if (tokenType) {
    ...
    function chainingSubstitutionFormat3(contextParams, subtable) {
        var lookupsCount = (subtable.inputCoverage.length +
        ...
        var contextRulesMatch = (inputLookups.length === subtable.inputCoverage.length &&
    ...
    FeatureQuery.prototype.getLookupMethod = function (lookupTable, subtable) {
        ...
        switch (substitutionType) {
            ...
            default:
                throw new Error("lookupType: " + (lookupTable.lookupType) + " - " +
    ...
    FeatureQuery.prototype.lookupFeature = function (query) {
        ...
        if (!feature) {
            return new Error("font '" + (this.font.names.fullName.en) + "' " +
    ...
    FeatureQuery.prototype.supports = function (query) {
        ...
        var supportedFeature = (this.features[query.script].some(function (feature) { return feature.tag === query.tag; }));
        ...
        switch (true) {
            ...
            case (!isArabicChar(nextChar) && !isTashkeelArabicChar(nextChar)):
                ...
                if (nextIsWhitespace) {
                    ...
                    arabicCharAhead = (contextParams.lookahead.some(function (c) { return isArabicChar(c) || isTashkeelArabicChar(c); }));
                    if (!arabicCharAhead) {
                        return true;
                    }
                }
    ...
    function arabicPresentationForms(range) {
        ...
        var contextParams = new ContextParams(tokens.map(function (token) { return token.getState('glyphIndex'); }), 0);
        var charContextParams = new ContextParams(tokens.map(function (token) { return token.char; }), 0);
    ...
    function arabicRequiredLigatures(range) {
        ...
        contextParams.context.forEach(function (glyphIndex, index) {
            ...
            if (substitutions.length) {
                substitutions.forEach(function (action) { return applySubstitution(action, tokens, index); });
    ...
    Bidi.prototype.registerFeatures = function (script, tags) {
        var this$1 = this;
        var supportedTags = tags.filter(function (tag) { return this$1.query.supports({ script: script, tag: tag }); });
    ...
    function checkGlyphIndexStatus() {
        if (this.tokenizer.registeredModifiers.indexOf('glyphIndex') === -1) {
            throw new Error('glyphIndex modifier is required to apply ' +
